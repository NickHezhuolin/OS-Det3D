...
class BEVFormerHead_LOUD(DETRHead):
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
        ...
        super(BEVFormerHead_LOUD, self).__init__(
    ...
    def get_owod_target(self,
        ...
        # gt_bbox.shape = [900,9] , xyz, wlh, raw, vx, vy
        # boxes.shape=10 , 取boxes[:,:8] , xyz, wlh, sinθ, cosθ, vx, vy
