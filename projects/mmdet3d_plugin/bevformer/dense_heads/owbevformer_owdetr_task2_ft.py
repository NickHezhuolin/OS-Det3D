...
class OWBEVFormer_OWDETR_task2_ft(DETRHead):
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
        ...
        super(OWBEVFormer_OWDETR_task2_ft, self).__init__(
    ...
    def get_owod_target(self,
        ...
        Returns:
            tuple[Tensor]: a tuple containing the following for one image.
                ...
                - neg_inds (Tensor): Sampled negative indices for each image.
        """
        #OWOD selection - 隐式BEV空间中的 900 个候选框中选
        pos_inds = copy.deepcopy(pos_inds_list[0])
        neg_inds = copy.deepcopy(pos_inds_list)
        
        #OWOD output init
        owod_bbox_preds_list = copy.copy(bbox_pred_list[0])
    ...
    def loss(self,
        ...
        if self.owod:
            loss_dict['loss_bowod'] = losses_owod[-1]
