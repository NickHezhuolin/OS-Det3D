...
class OWCustomNuScenesDataset7CLS(NuScenesDataset):
    r"""NuScenes Dataset.
    ...
    TRAIN_CLASSES = (    'car', 'construction_vehicle', 'bus', 'barrier',
    'bicycle', 'pedestrian', 'traffic_cone'
                )
    EVAL_CLASSES = (    'car', 'construction_vehicle', 'bus', 'barrier',
    'bicycle', 'pedestrian', 'traffic_cone', 'unknow_obj')
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = OWCustomNuScenesDataset7CLS.DefaultAttribute[name]
                else:
