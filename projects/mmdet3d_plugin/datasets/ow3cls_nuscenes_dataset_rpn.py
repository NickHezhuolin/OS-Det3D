...
class OWCustomNuScenesDataset3CLSRPN(NuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index):
        ...
        if self.modality['use_camera']:
            ...
            proposal_path = f'data/lidar_rpn/voxel_agno_3cls_train/{file_name}.pkl'
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = OWCustomNuScenesDataset3CLSRPN.DefaultAttribute[name]
                else:
