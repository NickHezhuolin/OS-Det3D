...
@DATASETS.register_module()
class CustomNuScenesDataset3cls(NuScenesDataset):
    r"""NuScenes Dataset.
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = CustomNuScenesDataset3cls.DefaultAttribute[name]
                else:
...
@DATASETS.register_module()
class CustomNuScenesDataset5cls(NuScenesDataset):
    r"""NuScenes Dataset.
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = CustomNuScenesDataset5cls.DefaultAttribute[name]
                else:
                    if name in ['pedestrian']:
                        attr = 'pedestrian.standing'
                    elif name in ['bus']:
...
@DATASETS.register_module()
class CustomNuScenesDataset10cls(NuScenesDataset):
    r"""NuScenes Dataset.
    ...
    CLASSES = (    'car', 'construction_vehicle', 'barrier',
    'bicycle', 'pedestrian','unk_obj', 'truck','bus', 'motorcycle', 'trailer', 'traffic_cone')
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = CustomNuScenesDataset10cls.DefaultAttribute[name]
                else:
                    if name in ['pedestrian']:
                        attr = 'pedestrian.standing'
                    elif name in ['bus']:
