...
class OWCustomNuScenesDataset10CLSOBJRPN(NuScenesDataset):
    r"""NuScenes Dataset.
    ...
    'bicycle', 'pedestrian', 'truck', 'bus', 'trailer', 'traffic_cone', 'motorcycle'
                )
    EVAL_CLASSES = (        'car', 'construction_vehicle', 'barrier',
    'bicycle', 'pedestrian', 'truck', 'bus', 'trailer', 'traffic_cone', 'motorcycle', 'unk_obj')
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = OWCustomNuScenesDataset10CLSOBJRPN.DefaultAttribute[name]
                else:
