...
# only train 'truck', 'bus', 'motorcycle'
# but eval car', 'construction_vehicle', 'barrier', 'bicycle', 'pedestrian', 'truck', 'bus', 'motorcycle' ; others as unk_obj
...
eval_class_names = [
    'car', 'construction_vehicle', 'barrier',
    'bicycle', 'pedestrian', 'truck', 'bus', 'motorcycle' , 'unk_obj'
]
...
dataset_type = 'OWCustomNuScenesDatasetUnkGT_Task2'
...
work_dir = 'work_dirs/owbevformer_base_unk_gt_task1_ft'
