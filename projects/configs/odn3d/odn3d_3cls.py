...
data = dict(
    ...
    val=dict(pipeline=test_pipeline, ann_file=data_root + 'nuscenes_infos_train.pkl', classes=class_names, modality=input_modality),
    test=dict(pipeline=test_pipeline, ann_file=data_root + 'nuscenes_infos_train.pkl', classes=class_names, modality=input_modality))
