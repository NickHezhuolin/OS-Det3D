...
eval_class_names = [
    'car', 'truck', 'construction_vehicle', 'bus', 'trailer', 'barrier',
    'motorcycle', 'bicycle', 'pedestrian', 'traffic_cone', 'unk_obj'
]
...
dataset_type = 'OWCustomNuScenesDataset10CLSOBJRPN'
...
work_dir = 'work_dirs/bevformer_base_loud_10cls'