...
eval_class_names = [
    'car', 'construction_vehicle', 'barrier', 'bicycle', 'pedestrian', 'unk_obj'
]
...
dataset_type = 'OWCustomNuScenesDataset5CLS_UnkGT'
...
work_dir = 'work_dirs/bevformer_base_5cls_unk_gt'