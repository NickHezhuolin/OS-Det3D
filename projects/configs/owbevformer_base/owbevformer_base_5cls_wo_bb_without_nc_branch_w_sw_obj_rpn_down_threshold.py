...
model = dict(
    ...
    pts_bbox_head=dict(
        type='OWBEVFormerHeadV1RPNV1_with_soft_weight_without_nc_branch_with_single_down_threshold',
        bev_h=bev_h_,
        bev_w=bev_w_,
        num_query=900,
...
work_dir = 'work_dirs/owbevformer_custom_epoch_18_5_cls_rpn_without_bbox_refine_and_nc_branch_with_soft_weoght_and_down_threshold_0118'
