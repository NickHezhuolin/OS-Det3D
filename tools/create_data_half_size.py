...
import sys
sys.path.append('.')
sys.path.append('/home/pujian/HZL/1_OW3D_RPN/BEVFormer/tools')

from data_converter.create_gt_database import create_groundtruth_database
from data_converter import nuscenes_converter_half as nuscenes_converter
...
def nuscenes_data_prep(root_path,
    ...
    if version == 'v1.0-test':
        ...
        info_train_path = osp.join(
            out_dir, f'{info_prefix}_half_infos_temporal_train.pkl')
